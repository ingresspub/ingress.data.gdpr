...
public class MentoringReport {
    ...
    private final ReportDetails<List<CountBasedRecord>> agentsRecruited;

    public MentoringReport(final ReportDetails<List<CountBasedRecord>> agentsRecruited) {
        notNull(agentsRecruited, "Missing details about agents recruited");
        this.agentsRecruited = agentsRecruited;
        this.agentsRecruited.setDataType(DataType.COUNTER);
    }

    @JsonProperty("agents_recruited")
    public ReportDetails<List<CountBasedRecord>> getAgentsRecruited() {
